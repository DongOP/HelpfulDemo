package com.eagle.psdedittext.view;
...
import com.eagle.psdedittext.R;

/**
 * Created by Dong on 2017/6/19 0019.
 */

public class PasswordExitText extends EditText implements
    ...
    public PasswordExitText(Context context) {
        this(context, null);
    }

    public PasswordExitText(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.editTextStyle);
    }

    public PasswordExitText(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init() {
        ...
        if (mToggleDrawable == null) {
            mToggleDrawable = getResources().getDrawable(R.drawable.set_show_password);
        }
